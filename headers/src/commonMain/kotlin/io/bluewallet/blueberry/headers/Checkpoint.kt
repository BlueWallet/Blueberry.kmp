...
val CHECKPOINTS: Map<Int, YearCheckpoint> =
    mapOf(
        2009 to
            YearCheckpoint(
                "2009",
...
fun checkpointForYear(year: Int): YearCheckpoint = CHECKPOINTS[year] ?: throw IllegalArgumentException("unknown checkpoint year: $year")
