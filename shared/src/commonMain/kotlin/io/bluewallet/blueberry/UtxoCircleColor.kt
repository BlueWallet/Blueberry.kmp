...
fun utxoCircleRgbHex(outpoint: String): String =
    sha256Hex(outpoint.encodeToByteArray()).take(6)

fun utxoCircleArgb(outpoint: String): Long =
    0xFF000000L or utxoCircleRgbHex(outpoint).toLong(16)

fun visibleUtxoCircleCount(total: Int, maxFit: Int): Int {
...
fun maxUtxoCirclesThatFit(available: Float, diameter: Float, step: Float): Int {
